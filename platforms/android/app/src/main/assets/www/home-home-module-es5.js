...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../model/login */
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(authenticationService, router, formBuilder, alertCtrl) {
      ...
      _createClass(HomePage, [{
        ...
        value: function login() {
          ...
          this.authenticationService.login(this.model.userName, this.model.password).subscribe(function (response) {
            sessionStorage.setItem('currentUser', JSON.stringify({
              userName: _this.model.userName,
              token: response.jwt
            }));
            sessionStorage.setItem('presentUser', _this.model.userName);
